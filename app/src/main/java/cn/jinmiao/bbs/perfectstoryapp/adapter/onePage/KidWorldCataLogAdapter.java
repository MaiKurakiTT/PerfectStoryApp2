 ...
 */
public class KidWorldCataLogAdapter extends BaseAdapter {
    ...
    public KidWorldCataLogAdapter(HomeFragment homeFragment, Context mContext, List<HomeCatalog> homeCatalogList) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if(convertView==null)
        {
            ...
            convertView=LayoutInflater.from(mContext).inflate(R.layout.item_fragment_home_etdt,null);
            beforeSleepViewHolder.ETDTStory_TextView=(TextView) convertView.findViewById(R.id.childWorldStory_Item_id);
        ...
        beforeSleepViewHolder.ETDTStory_TextView.setText(homeCatalog.getTitle()+"");
