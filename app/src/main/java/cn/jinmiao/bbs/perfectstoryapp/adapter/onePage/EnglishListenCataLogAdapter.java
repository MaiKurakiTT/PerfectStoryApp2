 ...
 */
public class EnglishListenCataLogAdapter extends BaseAdapter {
    ...
    public EnglishListenCataLogAdapter(HomeFragment homeFragment, Context mContext, List<HomeCatalog> homeCatalogList) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if(convertView==null)
        {
            ...
            convertView=LayoutInflater.from(mContext).inflate(R.layout.item_fragment_home_english_listen,null);
            beforeSleepViewHolder.englishListenStory_TextView=(TextView) convertView.findViewById(R.id.englishListenlStory_Item_id);
        ...
        beforeSleepViewHolder.englishListenStory_TextView.setText(homeCatalog.getTitle()+"");
    ...
    final  class BeforeSleepViewHolder{
        TextView englishListenStory_TextView;
    }
}
