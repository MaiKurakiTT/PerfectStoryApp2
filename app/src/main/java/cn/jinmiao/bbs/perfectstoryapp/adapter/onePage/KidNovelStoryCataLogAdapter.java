 ...
 */
public class KidNovelStoryCataLogAdapter extends BaseAdapter {
    ...
    public KidNovelStoryCataLogAdapter(HomeFragment homeFragment, Context mContext, List<HomeCatalog> homeCatalogList) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if(convertView==null)
        {
            ...
            convertView=LayoutInflater.from(mContext).inflate(R.layout.item_fragment_home_kid_novel,null);
            beforeSleepViewHolder.KidNovelStory_TextView=(TextView) convertView.findViewById(R.id.KidNovelStory_Item_id);
        ...
        beforeSleepViewHolder.KidNovelStory_TextView.setText(homeCatalog.getTitle()+"");
    ...
    final  class BeforeSleepViewHolder{
        TextView KidNovelStory_TextView;
    }
}
