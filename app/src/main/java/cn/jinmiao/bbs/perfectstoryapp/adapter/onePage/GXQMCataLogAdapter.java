 ...
 */
public class GXQMCataLogAdapter extends BaseAdapter {
    ...
    public GXQMCataLogAdapter(HomeFragment homeFragment, Context mContext, List<HomeCatalog> homeCatalogList) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if(convertView==null)
        {
            ...
            convertView=LayoutInflater.from(mContext).inflate(R.layout.item_fragment_home_gxqm,null);
            beforeSleepViewHolder.GXQMStory_TextView=(TextView) convertView.findViewById(R.id.guoxueqimenglStory_Item_id);
        ...
        beforeSleepViewHolder.GXQMStory_TextView.setText(homeCatalog.getTitle()+"");
