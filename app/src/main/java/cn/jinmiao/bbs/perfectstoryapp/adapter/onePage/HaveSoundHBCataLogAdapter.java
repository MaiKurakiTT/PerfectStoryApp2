 ...
 */
public class HaveSoundHBCataLogAdapter extends BaseAdapter {
    ...
    public HaveSoundHBCataLogAdapter(HomeFragment homeFragment, Context mContext, List<HomeCatalog> homeCatalogList) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if(convertView==null)
        {
            ...
            convertView=LayoutInflater.from(mContext).inflate(R.layout.item_fragment_home_have_sound_hb,null);
            beforeSleepViewHolder.HaveSoundHBStory_TextView=(TextView) convertView.findViewById(R.id.haveSoundHBStory_Item_id);
        ...
        beforeSleepViewHolder.HaveSoundHBStory_TextView.setText(homeCatalog.getTitle()+"");
    ...
    final  class BeforeSleepViewHolder{
        TextView HaveSoundHBStory_TextView;
    }
}
