...
public class SharePreferenceObjectTools {
    ...
    public static Object readSharePreferencesObject(Context context,String fileName,String key ){
        try {
    ...
    public static void SharePreferencesSaveObject(Context context,String fileName,String key,Object obj){
        try {
            // 保存对象
