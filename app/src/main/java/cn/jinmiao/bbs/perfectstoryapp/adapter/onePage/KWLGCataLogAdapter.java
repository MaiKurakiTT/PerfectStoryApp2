 ...
 */
public class KWLGCataLogAdapter extends BaseAdapter {
    ...
    public KWLGCataLogAdapter(HomeFragment homeFragment, Context mContext, List<HomeCatalog> homeCatalogList) {
